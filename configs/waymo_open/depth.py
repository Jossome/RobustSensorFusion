_base_ = [
    '../_base_/models/universenet50_2008_depth.py',
    '../_base_/datasets/waymo_open_2d_detection_depth_f0_mstrain_640_1280.py',
    '../_base_/schedules/schedule_depth.py', '../_base_/waymo_runtime.py',
