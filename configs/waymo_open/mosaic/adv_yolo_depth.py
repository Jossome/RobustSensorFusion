...
train_pipeline = [
    dict(type='LoadPointsForAttack', load_dim=6, use_dim=3),
    ...
    dict(type='DefaultFormatBundleAttack'),
    dict(type='Collect', keys=['points', 'img', 'gt_bboxes', 'gt_labels'],
         meta_keys=('filename', 'ori_filename', 'ori_shape', 'img_shape',
                    'pad_shape', 'scale_factor', 'flip', 'flip_direction',
                    'img_norm_cfg', 'pose', 'extrinsic', 'intrinsic', 'metadata',
                    'img_meta_vector'))
]
test_pipeline = [
    dict(type='LoadDepthImageFromFile'),
...
# start from 1e-5, then to optimizer.lr, then back to 1e-5
...
load_from = '/home/research/joss/universenet/work_dirs/yolov4m_depth_waymo_mosaic/latest.pth'  # noqa
resume_from = None
