...
# optimizer
optimizer = dict(type='SGD', lr=0.0001 * 1e-5, momentum=0.937, weight_decay=0.0005,
                 nesterov=True,
...
load_from = '/home/research/joss/universenet/work_dirs/yolov4m_rgb_waymo_mosaic/latest.pth'  # noqa
resume_from = None
