...
class Keep(object):
    """
    Do nothing, keep the original input and return.
    """
    def __init__(self):
        return

    def __call__(self, results):
        """Return results as it is.

        Args:
            results (dict): Result dict from loading pipeline.

        Returns:
            dict: Just the original results
        """
        return results
...
class RandomCenterCropPad(object):
    ...
    def __call__(self, results):
        ...
        if self.test_mode or self.attack_mode:
    ...
    def __repr__(self):
        ...
        repr_str += f'attack_mode={self.attack_mode}, '
